...
- 调度可用条件建议表达为 `running_count + reserved_count < max_concurrency`；
...
(1, 'NODE-001', '计算节点-1', 'node-token-001', '127.0.0.1', 'ONLINE', 1, 4, 1, 0, 23.50, 41.20, NOW(), NOW(), NOW()),
(2, 'NODE-002', '计算节点-2', 'node-token-002', '127.0.0.2', 'OFFLINE', 0, 2, 0, 0, 0.00, 0.00, NOW(), NOW(), NOW());
