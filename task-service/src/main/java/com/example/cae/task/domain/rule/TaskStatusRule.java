...
public class TaskStatusRule {
	...
	static {
		...
		TRANSFER_MAP.put("SCHEDULED", Set.of("DISPATCHED", "QUEUED", "FAILED"));
		TRANSFER_MAP.put("DISPATCHED", Set.of("RUNNING", "QUEUED", "FAILED"));
		TRANSFER_MAP.put("RUNNING", Set.of("SUCCESS", "FAILED", "TIMEOUT"));
